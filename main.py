...
COUNTRY_ALIASES = {
    ...
    "south dakota": {"south dakota", "sd", "south dakotais", "south dakotaise", "south dakotaien"},
    "north dakota": {"north dakota", "nd", "north dakotais", "north dakotaise", "north dakotaien"},
    ...
    "south carolina": {"south carolina", "sc", "south carolinais", "south carolinaise", "south carolinaien"},
    "north carolina": {"north carolina", "nc", "north carolinais", "north carolinaise", "north carolinaien"},
    "virginia": {"virginia", "virginiais", "virginiaise", "virginiaien"},
    "west virginia": {"west virginia", "wv", "west virginiais", "west virginiaise", "west virginiaien"},
    "pennsylvania": {"pennsylvania", "pennsylvaniais", "pennsylvaniaise", "pennsylvaniaien"},
    "new york": {"new york", "ny", "new yorkais", "new yorkaise", "new yorkien"},
    "maryland": {"maryland", "marylandais", "marylandaise", "marylandien"},
    "delaware": {"delaware", "delawareis", "delawareise", "delawareien"},
    "new jersey": {"new jersey", "nj", "new jerseyais", "new jerseyaise", "new jerseyien"},
    "connecticut": {"connecticut", "connecticutis", "connecticutise", "connecticutien"},
    "rhode island": {"rhode island", "ri", "rhode islandis", "rhode islandise", "rhode islandien"},
    ...
    "new hampshire": {"new hampshire", "nh", "new hampshireis", "new hampshireise", "new hampshireien"},
    ...
    "ireland": {"ireland", "irlande", "irlandais", "irlandaise"},
